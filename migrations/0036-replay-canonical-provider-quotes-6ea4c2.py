...
class MigrationStep(migrations.AbstractMigrationStep):
    ...
    def migration_id(self):
        return "6ea4c2a2-b81d-4cdd-b0e6-f563a1e89ec7"
    ...
    def upgrade(self, session):
        # Version 6 replays selected chats after realm message mappings have
        # converged so historical Zulip quote fences become canonical Workspace
        # quote references even when the reply was imported before its target.
        session.execute(
            """
