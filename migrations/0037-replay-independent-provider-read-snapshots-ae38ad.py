...
class MigrationStep(migrations.AbstractMigrationStep):
    def __init__(self):
        self._depends = ["0036-replay-canonical-provider-quotes-6ea4c2.py"]

    @property
    def migration_id(self):
        return "ae38ad4b-d1a3-471a-b488-31278920f3ca"
    ...
    def upgrade(self, session):
        # Version 7 emits owner read state as an independent operation.  Replay
        # every selected chat so a stale content snapshot cannot hide the
        # current Zulip read flag behind backend message freshness fencing.
        session.execute(
            """
