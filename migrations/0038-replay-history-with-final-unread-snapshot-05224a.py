...
class MigrationStep(migrations.AbstractMigrationStep):
    def __init__(self):
        self._depends = ["0037-replay-independent-provider-read-snapshots-ae38ad.py"]

    @property
    def migration_id(self):
        return "05224aa2-9532-4f8c-98ed-c24df1b6422c"
    ...
    def upgrade(self, session):
        # Version 8 combines each historical message with its owner read flag
        # and appends a causal unread-counter finalizer. Replay every selected
        # chat so installations upgraded from version 7 cannot retain a
        # completed history job without the finalizer.
        session.execute(
            """
