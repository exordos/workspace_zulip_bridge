...
class MigrationStep(migrations.AbstractMigrationStep):
    def __init__(self):
        self._depends = ["0015-scale-large-synchronizations-ad12e8.py"]

    @property
    def migration_id(self):
        return "e76ed089-6eb7-4225-8186-ce0bf24b3ea5"
    ...
    def upgrade(self, session):
        # Reaction snapshots are embedded in message history. Replay every
        # selected chat's configured window so legacy name-based reactions are
        # converged and the backend receives the canonical Unicode glyph. A
        # "new" chat is bounded by its original cutoff instead of becoming an
